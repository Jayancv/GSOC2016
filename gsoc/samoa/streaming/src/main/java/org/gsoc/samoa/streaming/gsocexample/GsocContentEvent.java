...
public class GsocContentEvent implements ContentEvent {

    private static final long serialVersionUID = -2406968925730298156L;
    private final boolean isLastEvent;
    private final int gsocData;

    public GsocContentEvent(int gsocData, boolean isLastEvent) {
        this.isLastEvent = isLastEvent;
        this.gsocData = gsocData;
    }

    public GsocContentEvent() {
        this(0, false);
    }
    ...
    public int getGsocData() {
        return gsocData;
    }

    @Override
    public String toString() {
        return "GsocContentEvent [gsocData=" + gsocData + "]";
    }
}
